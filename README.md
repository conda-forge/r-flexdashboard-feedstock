...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-flexdashboard-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-flexdashboard-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-flexdashboard-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-flexdashboard-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-flexdashboard-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-flexdashboard-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-flexdashboard` can be installed with:

```
conda install r-flexdashboard
```

It is possible to list all of the versions of `r-flexdashboard` available on your platform with:
